...
class PersonelUrunDetayPage extends StatefulWidget {
  const PersonelUrunDetayPage({Key? key}) : super(key: key);

  @override
  State<PersonelUrunDetayPage> createState() => _PersonelUrunDetayPageState();
}

class _PersonelUrunDetayPageState extends State<PersonelUrunDetayPage> {
  @override
