...
class PersonelMasaDetayPage extends StatefulWidget {
  const PersonelMasaDetayPage({Key? key}) : super(key: key);

  @override
  State<PersonelMasaDetayPage> createState() => _PersonelMasaDetayPageState();
}

class _PersonelMasaDetayPageState extends State<PersonelMasaDetayPage> {
  @override
  void initState() {
    _isCapChange = false;
    _isNameChange = false;
...
_sendRefData(BuildContext context, Personel cafe) async {
  if (_isCapChange) {
...
_sendRefCap(BuildContext context, Personel cafe) async {
...
_sendRefName(BuildContext context, Personel cafe) async {
  WebSocketChannel channel = IOWebSocketChannel.connect(urlPeronel);
