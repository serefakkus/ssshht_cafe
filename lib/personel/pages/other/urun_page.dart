...
class PersonelUrunPage extends StatefulWidget {
  const PersonelUrunPage({Key? key}) : super(key: key);

  @override
  State<PersonelUrunPage> createState() => _PersonelUrunPageState();
}

class _PersonelUrunPageState extends State<PersonelUrunPage> {
  @override
          ...
          return Container(
            ...
            child: CircleAvatar(
              ...
              child: IconButton(
                ...
                iconSize: 35,
                onPressed: () {
                  Navigator.pushNamed(context, '/YeniUrunPage',
                      arguments: _cafe);
                },
              ),
            ),
