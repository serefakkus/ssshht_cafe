...
class PersonelKodGirisPage extends StatelessWidget {
  const PersonelKodGirisPage({Key? key}) : super(key: key);
...
sendCodePass(BuildContext context) async {
  ...
  if (_phonecontroller.text.isNotEmpty || _codecontroller.text.isNotEmpty) {
    ...
    Phone phone = Phone();
    phone.no = _phonecontroller.text;
    phone.code = _codecontroller.text;
    mus.phone = phone;
    mus.istekTip = 'login_pass_ref_code';
