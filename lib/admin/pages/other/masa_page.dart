...
class CafeMasaPage extends StatefulWidget {
  const CafeMasaPage({Key? key}) : super(key: key);

  @override
  State<CafeMasaPage> createState() => _CafeMasaPageState();
}

class _CafeMasaPageState extends State<CafeMasaPage> {
  @override
  @override
...
_sendRefMasa(BuildContext context, Cafe cafe) async {
  var tok = Tokens();
