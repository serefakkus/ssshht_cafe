...
class CafeAyar {
  ...
  CafeAyar.fromMap(Map<String, dynamic> json) {
    isPdf = json["is_pdf"];
    pdfUrl = json["pdf_url"];
    isStaticMenu = json["is_static"];
    if (json["menu_images"] != null) {
      menuImages = List<String>.from(json["menu_images"]);
    }
...
class CafeInfo {
  ...
  CafeInfo.fromJson(Map<String, dynamic> json) {
    ...
    if (json["cafe_loc"] != null) {
      cafeLoc = CafeLoc.fromMap(json["cafe_loc"]);
    }
  }
...
class SiparisUrun {
  ...
  factory SiparisUrun.fromMap(Map<String, dynamic> json) => SiparisUrun(
        ...
        urunId: json["urun_id"],
        not: json["not"],
        tl: double.parse(json["ucret"].toString()),
        adet: json["adet"],
        puan: double.parse(json["puan"].toString()),
...
class SiparisSor {
  ...
  SiparisSor({this.status, this.userId, this.aktif, this.arsiv});
